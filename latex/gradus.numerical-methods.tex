...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/skycoords.pdf}
    \caption{\todo{figure}}
...
\begin{equation}
    ...
    \right),
\end{equation}
where the partial derivative term denotes the cartesian to spherical coordinate Jacobian. The component $p_{(t)}$ is the negative of the energy measured in the local frame, and is conventionally set to $-p_{(t)} = E = 1$ without loss of generality. 
