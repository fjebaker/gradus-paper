...
difference is consistent with a constant multiplicative factor along the time /
lag axes, which is likely due to the inclusion of a weak field approximation in
\citet{cackett_modelling_2014} (see \ref{appendix:continuum}).
