...
\textit{no-hair} uniqueness theorems\footnote{In these \emph{no-hair} theorems, `hair' is metaphor for additional information in
...
\citealt{bambi_testing_2023}). To test our implementation, we compare the line
profiles calculated with \Gradus for the Johannsen spacetime
\citep{johannsen_regular_2013} to the line profiles calculated using the
\texttt{rellinenk} of \citneeded. \todo{a comparison figure}.
