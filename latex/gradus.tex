...
razor-thin counterparts \citep{taylor_exploring_2018}. With the current
resolution and signal to noise of contemporary instruments, it would be
difficult to disambiguate the effect of the disc height and coronal height. At
low inclination, if the disc were thick but the model used to fit the data
assumes a thin geometry, the recovered lag would be an overestimate, and
therefore increase the uncertainty on the recovered black hole mass.
