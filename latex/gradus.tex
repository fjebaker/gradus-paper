...
given by
\begin{equation}
    \xi = \frac{4 \pi F_i}{n_\text{e}}
\end{equation}
where $F_i$ is the total illuminating X-ray flux in a given energy band $i$,
often in the range $0.01 - 100 \text{ keV}$, and $n_\text{e}$ is the co-moving
electron density \citep{ross_effects_1993}. This formulation assumes constant
