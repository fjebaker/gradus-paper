...
with. Almost all convolution and lineprofile models assume a razor-thin disc in
...
lineprofiles of hot spots eclipsed in thick discs, \cite{pariev_line_1998} study
...
taylor_x-ray_2018_reverb} calculate tabular lineprofile models and reverberation
...
This section also includes high-resolution simulation results that examine the
effect of disc thickness on the X-ray reverberation lag. Intended applications
of and future work on the code are described in Section \ref{sec:applications}.
...
the integral directly at $h$ and $1 - h$ \citneeded{}. Finer grids for $r_\text{em}$
