...
energy range yields an \textit{impulse response function} $\psi(t)$, which shows
how the disc responds to the impulse of a coronal flash. This impulse response
depends on the properties of the illuminating corona, accretion disc, spacetime,
and inclination of the observer. Examples for different lamp post heights over
the full energy range are shown in the top panel of Figure
...
K}\alpha}(t)$, so that the area under the Fe K$\alpha$ impulse response function
is 1.
